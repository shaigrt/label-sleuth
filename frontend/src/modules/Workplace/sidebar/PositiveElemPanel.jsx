...
const PositiveElemPanel = ({ updateMainLabelState, updateLabelState }) => {
    ...
    const { handlePosLabelState, handleNegLabelState } = useLabelState(newPosElemLabelState, updateMainLabelState, updateLabelState)
    ...
    return (
        <Box>
            <Box sx={{ display: 'flex', flexDirection: 'row', alignItem: 'center', marginTop: "11px", borderBottom: "1px solid #e2e2e2", pb: "12px", justifyContent: 'center' }} >
                <p style={{ width: '100%', textAlign: "center"  }}><strong>Positive labels</strong></p>
            </Box>
            {(!posElemResult || posElemResult.length == 0)?
                <Box  sx={{ display: "flex", justifyContent: "center", mt:1, fontSize: "0.8rem", color: "rgba(0,0,0,.54)" }} >
                    <Typography sx={{ display: "flex", justifyContent: "center", fontSize: "0.8rem", color: "rgba(0,0,0,.54)" }}>
                        {`No elements were labeled as positive so far.`} 
                    </Typography>
                </Box> 
               :
               <Box  sx={{ display: "flex", justifyContent: "center", mt:1, fontSize: "0.8rem", color: "rgba(0,0,0,.54)" }} >
                <Typography sx={{ display: "flex", justifyContent: "center", fontSize: "0.8rem", color: "rgba(0,0,0,.54)" }}>
                    {`${posElemResult.length} elements were labeled as positive so far. `} 
                </Typography>
              </Box> 
...
export default PositiveElemPanel;